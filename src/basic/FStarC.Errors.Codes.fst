...
let default_settings : list error_setting =
  [
    ...
    Error_ProofObligationFailed                       , CAlwaysError, 9;
    ...
    Error_UnknownFatal_AssertionFailure               , CAlwaysError, 16;
    Error_Z3InvocationError                           , CAlwaysError, 17;
    Error_IDEAssertionFailure                         , CAlwaysError, 18;
    Error_Z3SolverError                               , CAlwaysError, 19;
    ...
    Fatal_NegativeUniverseConstNotSupported             , CFatal, 135;
    ...
    Fatal_PossibleInfiniteType                         , CFatal, 160;
    Fatal_PreModuleMismatch                           , CFatal, 161;
    Fatal_QualifierListNotPermitted                    , CFatal, 162;
    ...
    Fatal_TooManyArgumentsToFunction                   , CFatal, 173;
    ...
    Fatal_UnexpectedOrUnboundOperator                  , CFatal, 180;
    ...
    Error_FlagConflict                                , CAlwaysError, 362;
    Error_LSPError                                    , CAlwaysError, 363;
    ]
